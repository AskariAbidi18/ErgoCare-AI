...
interface FullReportResponse {
  ml_output: ReportResponse;
  rag_user_data: Record<string, unknown>;
  rag_report: string;
}
...
export default function App() {
  ...
  async function handleGenerateReport() {
    ...
    try {
      ...
      setTimeout(() => {
        document.getElementById("rag-report-section")?.scrollIntoView({
          behavior: "smooth",
          block: "start",
        });
      }, 100);
    } catch (err) {
      if (err instanceof Error) setReportError(err.message);
      else setReportError("Unknown error occurred.");
    } finally {
  ...
  // Parse RAG report into sections for rich rendering
  function parseRagReport(text: string) {
    ...
    for (const line of lines) {
      ...
      // Detect headings: lines that start with # or are ALL CAPS (short), or end with ':'
      const isHeading =
        /^#{1,3}\s/.test(trimmed) ||
        ...
        <form className="assessment-form" onSubmit={handleSubmit}>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-1">
              <div className="input-group">
                ...
                <select className="input-field" value={form.consent} onChange={(e) => updateField("consent", e.target.value)}>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-2">
              <div className="input-group">
                ...
                <select className="input-field" value={form.age_group} onChange={(e) => updateField("age_group", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <input type="text" className="input-field" value={form.department} onChange={(e) => updateField("department", e.target.value)} />
              </div>
              <div className="input-group">
                <label className="input-label">Designation</label>
                <select className="input-field" value={form.designation} onChange={(e) => updateField("designation", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.experience_years} onChange={(e) => updateField("experience_years", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.marital_status} onChange={(e) => updateField("marital_status", e.target.value)}>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-2">
              <div className="input-group">
                ...
                <input type="number" className="input-field" min={0} max={60} value={form.teaching_hours} onChange={(e) => updateField("teaching_hours", Number(e.target.value))} />
              </div>
              <div className="input-group">
                <label className="input-label">Administrative Hours per Week</label>
                <input type="number" className="input-field" min={0} max={60} value={form.admin_hours} onChange={(e) => updateField("admin_hours", Number(e.target.value))} />
              </div>
              <div className="input-group">
                <label className="input-label">Weekend Work Frequency</label>
                <select className="input-field" value={form.weekend_work} onChange={(e) => updateField("weekend_work", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <input type="number" className="input-field" min={1} max={5} value={form.role_overload} onChange={(e) => updateField("role_overload", Number(e.target.value))} />
                <span className="input-hint">1 = No overload, 5 = Severe overload</span>
              </div>
              <div className="input-group">
                <label className="input-label">Publication Pressure</label>
                <select className="input-field" value={form.publish_pressure} onChange={(e) => updateField("publish_pressure", e.target.value)}>
                  <option value="No">No</option>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-2">
              <div className="input-group">
                ...
                <select className="input-field" value={form.workspace_setup} onChange={(e) => updateField("workspace_setup", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.screen_position} onChange={(e) => updateField("screen_position", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.feet_support} onChange={(e) => updateField("feet_support", e.target.value)}>
                  <option value="Yes">Yes</option>
                  <option value="No">No</option>
                </select>
              </div>
              <div className="input-group">
                ...
                <select className="input-field" value={form.sitting_duration} onChange={(e) => updateField("sitting_duration", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.most_discomfort_activity} onChange={(e) => updateField("most_discomfort_activity", e.target.value)}>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-2">
              <div className="input-group">
                ...
                <select className="input-field" value={form.sleep_hours} onChange={(e) => updateField("sleep_hours", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.physical_activity} onChange={(e) => updateField("physical_activity", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.hydration} onChange={(e) => updateField("hydration", e.target.value)}>
              ...
              <div className="input-group">
                ...
                <select className="input-field" value={form.commute_time} onChange={(e) => updateField("commute_time", e.target.value)}>
                  <option value="Less than 30 mins">Less than 30 mins</option>
                  <option value="30 mins - 1 hour">30 mins - 1 hour</option>
                  <option value="1 - 2 hours">1 - 2 hours</option>
                  <option value="More than 2 hours">More than 2 hours</option>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-3">
              {(["neck_pain","lower_back_pain","wrist_pain","shoulder_pain","leg_pain","eye_strain"] as const).map((field) => (
                <div className="input-group" key={field}>
                  <label className="input-label">{field.replace(/_/g, " ").replace(/\b\w/g, (c) => c.toUpperCase())}</label>
                  <input type="number" className="input-field" min={0} max={5} value={form[field]} onChange={(e) => updateField(field, Number(e.target.value))} />
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="form-section">
            ...
            <div className="form-grid-1">
              {[
                { key: "who5_q1" as const, label: "I have felt cheerful and in good spirits" },
                { key: "who5_q2" as const, label: "I have felt calm and relaxed" },
                { key: "who5_q3" as const, label: "I have felt active and vigorous" },
                { key: "who5_q4" as const, label: "I woke up feeling fresh and rested" },
                { key: "who5_q5" as const, label: "My daily life has been filled with things that interest me" },
              ].map(({ key, label }) => (
                <div className="input-group" key={key}>
                  <label className="input-label">{label}</label>
                  <select className="input-field" value={form[key]} onChange={(e) => updateField(key, e.target.value)}>
          ...
          <div className="form-actions">
            <button className="submit-btn" type="submit" disabled={loading}>
              {loading ? (
                <><span className="spinner"></span>Analyzing Your Data...</>
              ) : (
                <>
          ...
          <div className="results" id="results">
            ...
            <div className="prediction-card" style={{ borderColor: getRiskColor(response.prediction.risk_label) }}>
              <div className="prediction-content">
                <div className="prediction-label-group">
                  ...
                  <h3 className="prediction-label-value" style={{ color: getRiskColor(response.prediction.risk_label) }}>
                    {response.prediction.risk_label}
                  </h3>
                </div>
                <div className="prediction-confidence">
                  <div className="confidence-label">Confidence Score</div>
                  <div className="confidence-value">{(response.prediction.confidence_score * 100).toFixed(1)}%</div>
                  <div className="confidence-bar">
                    <div className="confidence-fill" style={{ width: `${response.prediction.confidence_score * 100}%`, backgroundColor: getRiskColor(response.prediction.risk_label) }}></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="metrics-grid">
                <div className="metric-card">
                  <div className="metric-icon" style={{ background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 2C10.3431 2 9 3.34315 9 5C9 6.65685 10.3431 8 12 8C13.6569 8 15 6.65685 15 5C15 3.34315 13.6569 2 12 2Z" fill="white"/><path d="M7 22V14C7 12.8954 7.89543 12 9 12H15C16.1046 12 17 12.8954 17 14V22" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
                  </div>
                ...
                <div className="metric-card">
                  <div className="metric-icon" style={{ background: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)" }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="3" stroke="white" strokeWidth="2"/><path d="M12 5V2M12 22V19M19 12H22M2 12H5" stroke="white" strokeWidth="2" strokeLinecap="round"/><path d="M17 7L19 5M5 19L7 17M17 17L19 19M5 5L7 7" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
                  </div>
                ...
                <div className="metric-card">
                  <div className="metric-icon" style={{ background: "linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)" }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9.5 2C13.0899 2 16 4.91015 16 8.5C16 10.3736 15.1721 12.0569 13.8527 13.1918L20.5104 19.8494C20.8931 20.2321 20.8931 20.8474 20.5104 21.2301C20.1277 21.6128 19.5123 21.6128 19.1296 21.2301L12.4719 14.5725C11.3371 15.892 9.65381 16.7198 7.78027 16.7198C4.19037 16.7198 1.28027 13.8097 1.28027 10.2198C1.28027 6.62988 4.19037 3.71973 7.78027 3.71973" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
                  </div>
                ...
                <div className="metric-card">
                  <div className="metric-icon" style={{ background: "linear-gradient(135deg, #fa709a 0%, #fee140 100%)" }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M20 14C20 18.4183 16.4183 22 12 22C7.58172 22 4 18.4183 4 14" stroke="white" strokeWidth="2" strokeLinecap="round"/><path d="M12 2V6M8 4L12 6L16 4" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                ...
                <div className="metric-card">
                  <div className="metric-icon" style={{ background: "linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)" }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="white" strokeWidth="2"/><path d="M9 12H15M12 9V15" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
                  </div>
              ...
              <div className="probability-bars">
                <div className="probability-item">
                  ...
                  <div className="probability-bar">
                    <div className="probability-fill" style={{ width: `${response.model_probabilities.low * 100}%`, background: "var(--success)" }}></div>
                  </div>
                </div>
                <div className="probability-item">
                  <div className="probability-header">
                  ...
                  <div className="probability-bar">
                    <div className="probability-fill" style={{ width: `${response.model_probabilities.moderate * 100}%`, background: "var(--warning)" }}></div>
                  </div>
                </div>
                <div className="probability-item">
                  <div className="probability-header">
                  ...
                  <div className="probability-bar">
                    <div className="probability-fill" style={{ width: `${response.model_probabilities.high * 100}%`, background: "var(--danger)" }}></div>
                  </div>
                </div>
              </div>
            </div>

            {/* ── Generate Full AI Report CTA ── */}
            <div className="rag-cta-section">
              <div className="rag-cta-content">
                <div className="rag-cta-icon">
                ...
                <div className="rag-cta-text">
                  <h3 className="rag-cta-title">Want personalized recommendations?</h3>
                  <p className="rag-cta-desc">
                    Generate a detailed AI-powered report with targeted interventions, ergonomic tips, and a wellness action plan tailored to your risk profile.
                  </p>
                </div>
                <button
                  className="rag-btn"
            ...
            {reportError && (
              <div className="alert alert-error" style={{ marginTop: "1rem" }}>
                ...
                <div>
                  <h3 className="alert-title">Report Generation Failed</h3>
                  <p className="alert-message">{reportError}</p>
                </div>
              </div>
            )}
            ...
            {/* ── RAG Report Section ── */}
            {ragReport && (
              <div className="rag-report-section" id="rag-report-section">
                <div className="rag-report-header">
                  <div className="rag-report-badge">
                  ...
                  <h3 className="rag-report-title">Personalized Health Recommendations</h3>
                  <p className="rag-report-subtitle">
                    This report is generated by our RAG pipeline using your risk profile and evidence-based ergonomic guidelines.
                  </p>
                </div>

                <div className="rag-report-body">
                  {parseRagReport(ragReport).map((section, i) => (
                    <div className="rag-section" key={i}>
                      {section.heading && (
                        <div className="rag-section-heading">
                          <span className="rag-section-num">{String(i + 1).padStart(2, "0")}</span>
                          <h4 className="rag-section-title">{section.heading}</h4>
                        </div>
                      )}
                      <div className="rag-section-body">
                        {section.lines.map((line, j) => {
                          ...
                          return isBullet ? (
                            <div className="rag-bullet" key={j}>
                              <span className="rag-bullet-dot"></span>
                              <span>{cleaned}</span>
                            </div>
                          ) : (
                            <p className="rag-paragraph" key={j}>{line}</p>
                          );
                        })}
                      </div>
                    </div>
                ...
                <details className="json-details" style={{ marginTop: "1.5rem" }}>
                  <summary className="json-summary">View Raw Report Text</summary>
                  <pre className="json-content" style={{ whiteSpace: "pre-wrap" }}>{ragReport}</pre>
                </details>
              </div>
            )}
